...
def health():
    ...
    """
    try:
        # Check if predictor can be initialized
        if predictor is None:
            FakeNewsPredictor(model_type='random_forest')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="accordion" id="linguistic-accordion">
                                        <div class="accordion-item">
                                            ...
                                            <div id="fake-markers-collapse" class="accordion-collapse collapse" aria-labelledby="fake-markers-heading" data-bs-parent="#linguistic-accordion">
                                                <div class="accordion-body" id="fake-markers-content"></div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            ...
                                            <div id="real-markers-collapse" class="accordion-collapse collapse" aria-labelledby="real-markers-heading" data-bs-parent="#linguistic-accordion">
                                                <div class="accordion-body" id="real-markers-content"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-group" id="verification-tips"></ul>
                                </div>
                            </div>
                        </div>
                    </div>
